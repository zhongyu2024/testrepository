...
public class MD5Utils {
	...
	private static String md5Hex(String str) {
		try {
			...
			new HexBin();
			return new String(HexBin.encode(digest));
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] args) {
		System.out.println(getSaltMD5("1"));
		System.out.println(getSaltverifyMD5("1",getSaltMD5("1")));
/*		String strMD5 = new String("test01");
