...
public class FileUtils
{
  ...
  public static void copyFile(String sourceFilePath, String distFilePath)
    throws FileUtilException
  {
    try
    {
  ...
  public static void copyFile(File file, String distFilePath, String fileName)
    throws FileUtilException
  {
    try
    {
  ...
  public static void copyFilePath(String sourceFilePath, String distFilePath)
    throws FileUtilException
  {
    try
    {
      ...
      for (int i = 0; i < file.length; i++)
        if (file[i].isFile()) {
          ...
          FileOutputStream output = new FileOutputStream(distFilePath + "/" + file[i]
            .getName().toString());
  ...
  public static void writeFile(String filePath, String args, boolean isUTF8)
    throws IOException
  {
    if (isUTF8) {
  ...
  public static void writeFile(String filePath, String fileName, String args, boolean isUTF8)
    throws IOException
  {
  ...
  public static void readAllFile(String filePath, String fileName)
    throws IOException
  {
    FileReader fr = new FileReader(filePath + fileName);
    int count = fr.read();
  ...
  public static void readLineFile(String filePath, String fileName)
    throws IOException
  {
    FileReader fr = new FileReader(filePath + fileName);
    ...
    throws Exception
  {
    try
    {
      ...
      return file2ByteArrayInputStream(file); } catch (Exception e) {
    }
    ...
    throws Exception
  {
    try
    {
      ...
      return new ByteArrayInputStream(b); } catch (Exception e) {
    }
    throw new Exception("将文件转换为流的过程中出现错误!");
  }
  ...
  public String readFromIS(InputStream is)
    throws Exception
  {
    try
    {
