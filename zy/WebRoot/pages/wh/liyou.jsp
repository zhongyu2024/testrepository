	...
	<body>
		<div id="box" style="width: 90%;">
				...
				<div id="addpaihao" style="display:none;width: 300px;height: 200px;background-color:lightgoldenrodyellow ;position: absolute;top: 200px;left: 500px;">
						<div style="background-color: #F5F5F5;height: 36px;width: 300px;">
						...
						<div style="margin-top: 50px;clear: both;margin-left: 50px;">
									...
									<td>理由:</td>
									<td><input type="text" id="name1"></td><br>
									<span id="ae1"></span><br/>
				...
				<div id="editpaihao" style="display:none;width: 300px;height: 200px;background-color:lightgoldenrodyellow ;position: absolute;top: 200px;left: 500px;">
						<div style="background-color: #F5F5F5;height: 36px;width: 300px;">
						<div style="float: left;margin-left: 10px;">编辑理由</div>
						<div style="float: right;cursor: pointer;" class="cha"><img src="images/wh/w-cantai6.png"></div>
						</div>
						<div style="margin-top: 50px;clear: both;margin-left: 50px;">
							
									<td>理由:</td>
									<td><input type="text" id="name2"></td><br>
									<span id="ae2"></span><br/>
							<div style="margin-top: 30px;"> 
				...
				<div id="middle" style="clear: both;">
					...
					<div id="right" style="float: left;background-color: white;width:1000px">
						...
						<div style="clear: both;background-color: #F5F5F5;">
							<div style="float: left;cursor: pointer;" class="add"><img src="images/wh/w-yaoqiu1.png"></div>
							<div style="float: left;cursor: pointer;" class="edit"><img src="images/wh/w-yaoqiu2.png"></div>
							<div style="float: left;cursor: pointer;" class="delete"><img src="images/wh/w-yaoqiu3.png"></div>
							<div style="float: right;"></div>
						</div>
		...
		$(function(){
			...
			$("#i1").click(function(){
				...
				if(c){
					$.ajax({
						method:"get",//请求方式
	  					url:"liYou/addLiYou.do",//请求地址
	  					dataType:"html",
	  					data:{"name":ad1},
	  					success:function(result){
	  						if(result=="111"){
	  						window.location.href="liYou/findAll.do";
	  						}
	  					}
					});
				}
