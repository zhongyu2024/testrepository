...
public interface TdiandanMapper {
	...
	List<Mode> getALLliyou();
	Foodtable Foodtable(int tableid);
	void editlistT(ZList zl);
	void editlistinfo(@Param("id") int id, @Param("liyou") String liyou);
	Listinfo getlistinfoByid(int id);
	void editlistxiaofei(Listinfo listinfo);
	List<Hetable> gethtByAid(String id);
	List<Hetable> gethtByBid(String id);
	void edithetable(String id);
	void edittablestate(int tableid);
}
